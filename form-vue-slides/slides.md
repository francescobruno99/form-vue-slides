...
We have provided a few built-in components like `<Tweet/>` and `<Youtube/>` that you can use directly.
...
Themes can provide styles, layouts, components, or even configurations for tools.
